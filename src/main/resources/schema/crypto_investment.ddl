...
alter table if exists daily_stats drop constraint if exists UKbnggmk03hc945vywm90fbpfbd;
alter table if exists daily_stats add constraint UKbnggmk03hc945vywm90fbpfbd unique (maximum_id);
alter table if exists daily_stats drop constraint if exists UKb6w5sf7avbcmel27xlunywe93;
alter table if exists daily_stats add constraint UKb6w5sf7avbcmel27xlunywe93 unique (minimum_id);
...
alter table if exists daily_stats add constraint FKcfjt2yimhaeqdn3rgxfsicmu4 foreign key (maximum_id) references crypto_prices;
alter table if exists daily_stats add constraint FKhpop9wgxq9i9fvx5jnkuhmss7 foreign key (minimum_id) references crypto_prices;
